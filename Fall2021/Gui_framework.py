...
'''Sets up the class called PythagTheorem'''
class PythagTheorem(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.hypot = tk.StringVar() # sets the hypot variable toa string var so the gui can display it in a read only entry box
...
if __name__ == "__main__": # If this is the main module, run this code
    ...
    PythagTheorem(root) # calls the PythagTheorem class and passes in the root parent
